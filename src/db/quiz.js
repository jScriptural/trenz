...
export default [
  ...
  {
    q: `What is financial term represents the total value of a company's outstanding shares of stock?`,
    opts: [
      `Net income`,
  ...
  {
    q: `Which cryptographic algorithm is commonly used for secure data transmission over the internet, ensuring confidentiality and integrity?`,
    opts: [
  ...
  {
    q: `What term describes the phenomenon where two particles become correlated in such a way that the state of one particle directly influences the state of the other, regardless of the distance between them?`,
    opts: [
      `Superposition`,
      `Entanglement`,
      `Tunneling`,
